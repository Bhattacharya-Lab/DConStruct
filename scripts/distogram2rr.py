#!/usr/bin/python
## this program generates contact map (rr) file from distance map histogram (distogram) rawdistpred.current generated by DMPfold with user defined thereshold and length cutoff
import operator
import os
import math
import sys
